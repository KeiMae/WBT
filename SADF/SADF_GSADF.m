...
for i=swindow0:1:T; 
  badfs(i-swindow0+1,1)= ADF_FL(y(1:i,5),0,1);  
 % badfs(i-swindow0+1,1)= ADF_IC(y(1:i,1),12,1,2); 
end;   
sadf=max(badfs);
...
for v=1:1:size(r2,1);
    ...
    for i=1:1:size(swindow,1); 
       rwadft(i)= ADF_FL(y(r1(i):r2(v),5),0,1);   % two tail 5% significant level
       %rwadft(i)= ADF_IC(y(r1(i):r2(v),1),12,1,2); 
    end;  
